                                                ...
                                                console.log('Team Rouge');
                                                    ...
                                                    ActualGameLol.addFields(
                                                        ...
                                                        { name: 'Ban Team Rouge', value: `${champtionBanned5['name']}\n${champtionBanned6['name']}
                                                                                         ...
                                                                                         ${champtionBanned8['name']}`, inline: true},
                                                        { name: '\u200B', value: '\u200B' },
                                                    )
                                                        ...
                                                        if (!playerRank1[0]) {
                                                                ...
                                                                .then((playerChampNumber2) => {
                                                                    ...
                                                                    .then((playerRank2) => {
                                                                        ...
                                                                        console.log(`${currentGame['participants'][1]['summonerName']} | ${playerChampNumber2['name']}`);
                                                                        if (playerRank2[0]) {
                                                                        if (playerRank2[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                            ...
                                                                            ActualGameLol.addFields(
                                                                                { name: `${currentGame['participants'][1]['summonerName']} | ${playerChampNumber2['name']}`, value: `${playerRank2[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank2[0]['tier']} ${playerRank2[0]['rank']} ${playerRank2[0]['leaguePoints']} LP \n ${playerRank2[0]['wins']}W ${playerRank2[0]['losses']}L ${winrate}%`, inline: true },
                                                                                )
                                                                        }else{
                                                                            console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                        }
                                                                    ...
                                                                    if (playerRank2[1]) {
                                                                        if (playerRank2[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                            ...
                                                                            ActualGameLol.addFields(
                                                                                { name: `${currentGame['participants'][1]['summonerName']} | ${playerChampNumber2['name']}`, value: `${playerRank2[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank2[1]['tier']} ${playerRank2[1]['rank']} ${playerRank2[1]['leaguePoints']} LP \n ${playerRank2[1]['wins']}W ${playerRank2[1]['losses']}L ${winrate}%`, inline: true },
                                                                                )
                                                                        }else{
                                                                            console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                        }
                                                                    ...
                                                                    if (!playerRank2[0]) {
                                                                        ActualGameLol.addFields(
                                                                            { name: `${currentGame['participants'][1]['summonerName']}`, value: `${playerChampNumber2['name']}`, inline: true },
                                                                            )
                                                                }
                                                                            ...
                                                                            .then((playerChampNumber3) => {
                                                                                ...
                                                                                .then((playerRank3) => {
                                                                                    console.log(`${currentGame['participants'][2]['summonerName']} | ${playerChampNumber3['name']}`);
                                                                                    if (playerRank3[0]) {
                                                                                    if (playerRank3[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                        ...
                                                                                        ActualGameLol.addFields(
                                                                                            { name: `${currentGame['participants'][2]['summonerName']} | ${playerChampNumber3['name']}`, value: `${playerRank3[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank3[0]['tier']} ${playerRank3[0]['rank']} ${playerRank3[0]['leaguePoints']} LP \n ${playerRank3[0]['wins']}W ${playerRank3[0]['losses']}L ${winrate}%`, inline: true },
                                                                                            )
                                                                                    }else{
                                                                                        console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                    }}
                                                                                    ...
                                                                                    if (playerRank3[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                        ...
                                                                                        ActualGameLol.addFields(
                                                                                            { name: `${currentGame['participants'][2]['summonerName']} | ${playerChampNumber3['name']}`, value: `${playerRank3[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank3[1]['tier']} ${playerRank3[1]['rank']} ${playerRank3[1]['leaguePoints']} LP \n ${playerRank3[1]['wins']}W ${playerRank3[1]['losses']}L ${winrate}%`, inline: true },
                                                                                            )
                                                                                    }else{
                                                                                        console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                    }}
                                                                                    if (!playerRank3[0]) {
                                                                                        ActualGameLol.addFields(
                                                                                            { name: `${currentGame['participants'][2]['summonerName']}`, value: `${playerChampNumber3['name']}`, inline: true },
                                                                                            )
                                                                                }
                                                                                        ...
                                                                                        .then((playerChampNumber4) => {
                                                                                            ...
                                                                                            .then((playerRank4) => {
                                                                                                console.log(`${currentGame['participants'][3]['summonerName']} | ${playerChampNumber4['name']}`);
                                                                                                if (playerRank4[0]) {
                                                                                                if (playerRank4[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                    ...
                                                                                                    ActualGameLol.addFields(
                                                                                                        { name: `${currentGame['participants'][3]['summonerName']} | ${playerChampNumber4['name']}`, value: `${playerRank4[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank4[0]['tier']} ${playerRank4[0]['rank']} ${playerRank4[0]['leaguePoints']} LP \n ${playerRank4[0]['wins']}W ${playerRank4[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                        )
                                                                                                }else{
                                                                                                    console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                }}
                                                                                                ...
                                                                                                if (playerRank4[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                    ...
                                                                                                    ActualGameLol.addFields(
                                                                                                        { name: `${currentGame['participants'][3]['summonerName']} | ${playerChampNumber4['name']}`, value: `${playerRank4[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank4[1]['tier']} ${playerRank4[1]['rank']} ${playerRank4[1]['leaguePoints']} LP \n ${playerRank4[1]['wins']}W ${playerRank4[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                        )
                                                                                                }else{
                                                                                                    console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                }}
                                                                                                if (!playerRank4[0]) {
                                                                                                    ActualGameLol.addFields(
                                                                                                        { name: `${currentGame['participants'][3]['summonerName']}`, value: `${playerChampNumber4['name']}`, inline: true },
                                                                                                        )
                                                                                            }
                                                                                                    ...
                                                                                                    .then((playerChampNumber5) => {
                                                                                                        ...
                                                                                                        .then((playerRank5) => {
                                                                                                            console.log(`${currentGame['participants'][4]['summonerName']} | ${playerChampNumber5['name']}`);
                                                                                                            if (playerRank5[0]) {
                                                                                                            if (playerRank5[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                ...
                                                                                                                ActualGameLol.addFields(
                                                                                                                    { name: `${currentGame['participants'][4]['summonerName']} | ${playerChampNumber5['name']}`, value: `${playerRank5[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank5[0]['tier']} ${playerRank5[0]['rank']} ${playerRank5[0]['leaguePoints']} LP \n ${playerRank5[0]['wins']}W ${playerRank5[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                                    )
                                                                                                            }else{
                                                                                                                console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                            }}
                                                                                                            ...
                                                                                                            if (playerRank5[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                ...
                                                                                                                ActualGameLol.addFields(
                                                                                                                    { name: `${currentGame['participants'][4]['summonerName']} | ${playerChampNumber5['name']}`, value: `${playerRank5[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank5[1]['tier']} ${playerRank5[1]['rank']} ${playerRank5[1]['leaguePoints']} LP \n ${playerRank5[1]['wins']}W ${playerRank5[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                                    )
                                                                                                            }else{
                                                                                                                console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                            }}
                                                                                                            if (!playerRank5[0]) {
                                                                                                                ActualGameLol.addFields(
                                                                                                                    { name: `${currentGame['participants'][4]['summonerName']}`, value: `${playerChampNumber5['name']}`, inline: true },
                                                                                                                    )
                                                                                                        }
                                                                                                                ...
                                                                                                                .then((playerChampNumber6) => {
                                                                                                                    ...
                                                                                                                    .then((playerRank6) => {
                                                                                                                        console.log(`${currentGame['participants'][5]['summonerName']} | ${playerChampNumber6['name']}`);
                                                                                                                        if (playerRank6[0]) {
                                                                                                                        if (playerRank6[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                            ...
                                                                                                                            ActualGameLol.addFields(
                                                                                                                                { name: `${currentGame['participants'][5]['summonerName']} | ${playerChampNumber6['name']}`, value: `${playerRank6[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank6[0]['tier']} ${playerRank6[0]['rank']} ${playerRank6[0]['leaguePoints']} LP \n ${playerRank6[0]['wins']}W ${playerRank6[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                )
                                                                                                                        }else{
                                                                                                                            console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                        }}
                                                                                                                        ...
                                                                                                                        if (playerRank6[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                            ...
                                                                                                                            ActualGameLol.addFields(
                                                                                                                                { name: `${currentGame['participants'][5]['summonerName']} | ${playerChampNumber6['name']}`, value: `${playerRank6[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank6[1]['tier']} ${playerRank6[1]['rank']} ${playerRank6[1]['leaguePoints']} LP \n ${playerRank6[1]['wins']}W ${playerRank6[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                )
                                                                                                                        }else{
                                                                                                                            console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                        }}
                                                                                                                        if (!playerRank6[0]) {
                                                                                                                            ActualGameLol.addFields(
                                                                                                                                { name: `${currentGame['participants'][5]['summonerName']}`, value: `${playerChampNumber6['name']}`, inline: true },
                                                                                                                                )
                                                                                                                    }
                                                                                                                            ...
                                                                                                                            .then((playerChampNumber7) => {
                                                                                                                                ...
                                                                                                                                .then((playerRank7) => {
                                                                                                                                    console.log(`${currentGame['participants'][6]['summonerName']} | ${playerChampNumber7['name']}`);
                                                                                                                                    if (playerRank7[0]) {
                                                                                                                                    if (playerRank7[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                        ...
                                                                                                                                        ActualGameLol.addFields(
                                                                                                                                            { name: `${currentGame['participants'][6]['summonerName']} | ${playerChampNumber7['name']}`, value: `${playerRank7[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank7[0]['tier']} ${playerRank7[0]['rank']} ${playerRank7[0]['leaguePoints']} LP \n ${playerRank7[0]['wins']}W ${playerRank7[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                            )
                                                                                                                                    }else{
                                                                                                                                        console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                    }}
                                                                                                                                    ...
                                                                                                                                    if (playerRank7[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                        ...
                                                                                                                                        ActualGameLol.addFields(
                                                                                                                                            { name: `${currentGame['participants'][6]['summonerName']} | ${playerChampNumber7['name']}`, value: `${playerRank7[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank7[1]['tier']} ${playerRank7[1]['rank']} ${playerRank7[1]['leaguePoints']} LP \n ${playerRank7[1]['wins']}W ${playerRank7[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                            )
                                                                                                                                    }else{
                                                                                                                                        console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                    }}
                                                                                                                                    if (!playerRank7[0]) {
                                                                                                                                        ActualGameLol.addFields(
                                                                                                                                            { name: `${currentGame['participants'][6]['summonerName']}`, value: `${playerChampNumber7['name']}`, inline: true },
                                                                                                                                            )
                                                                                                                                }
                                                                                                                                        ...
                                                                                                                                        .then((playerChampNumber8) => {
                                                                                                                                            ...
                                                                                                                                            .then((playerRank8) => {
                                                                                                                                                console.log(`${currentGame['participants'][7]['summonerName']} | ${playerChampNumber8['name']}`);
                                                                                                                                                if (playerRank8[0]) {
                                                                                                                                                if (playerRank8[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                                    ...
                                                                                                                                                    ActualGameLol.addFields(
                                                                                                                                                        { name: `${currentGame['participants'][7]['summonerName']} | ${playerChampNumber8['name']}`, value: `${playerRank8[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank8[0]['tier']} ${playerRank8[0]['rank']} ${playerRank8[0]['leaguePoints']} LP \n ${playerRank8[0]['wins']}W ${playerRank8[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                                        )
                                                                                                                                                }else{
                                                                                                                                                    console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                                }}
                                                                                                                                                ...
                                                                                                                                                if (playerRank8[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                                    ...
                                                                                                                                                    ActualGameLol.addFields(
                                                                                                                                                        { name: `${currentGame['participants'][7]['summonerName']} | ${playerChampNumber8['name']}`, value: `${playerRank8[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank8[1]['tier']} ${playerRank8[1]['rank']} ${playerRank8[1]['leaguePoints']} LP \n ${playerRank8[1]['wins']}W ${playerRank8[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                                        )
                                                                                                                                                }else{
                                                                                                                                                    console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                                }}
                                                                                                                                                if (!playerRank8[0]) {
                                                                                                                                                    ActualGameLol.addFields(
                                                                                                                                                        { name: `${currentGame['participants'][7]['summonerName']}`, value: `${playerChampNumber8['name']}`, inline: true },
                                                                                                                                                        )
                                                                                                                                            }
                                                                                                                                                    ...
                                                                                                                                                    .then((playerChampNumber9) => {
                                                                                                                                                        ...
                                                                                                                                                        .then((playerRank9) => {
                                                                                                                                                            console.log(`${currentGame['participants'][8]['summonerName']} | ${playerChampNumber9['name']}`);
                                                                                                                                                            if (playerRank9[0]) {
                                                                                                                                                            if (playerRank9[0]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                                                ...
                                                                                                                                                                ActualGameLol.addFields(
                                                                                                                                                                    { name: `${currentGame['participants'][8]['summonerName']} | ${playerChampNumber9['name']}`, value: `${playerRank9[0]['queueType'].replace('_',' ').replace('_SR','').replace('_5x5',' DUO')}\n${playerRank9[0]['tier']} ${playerRank9[0]['rank']} ${playerRank9[0]['leaguePoints']} LP \n ${playerRank9[0]['wins']}W ${playerRank9[0]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                                                    )
                                                                                                                                                            }else{
                                                                                                                                                                console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                                            }}
                                                                                                                                                            ...
                                                                                                                                                            if (playerRank9[1]['queueType'] == 'RANKED_SOLO_5x5') {
                                                                                                                                                                ...
                                                                                                                                                                ActualGameLol.addFields(
                                                                                                                                                                    { name: `${currentGame['participants'][8]['summonerName']} | ${playerChampNumber9['name']}`, value: `${playerRank9[1]['queueType'].replace('_',' ').replace('_5x5',' DUO').replace('_SR','')}\n${playerRank9[1]['tier']} ${playerRank9[1]['rank']} ${playerRank9[1]['leaguePoints']} LP \n ${playerRank9[1]['wins']}W ${playerRank9[1]['losses']}L ${winrate}%`, inline: true },
                                                                                                                                                                    )
                                                                                                                                                            }else{
                                                                                                                                                                console.log('Pas de Ranked Solo Duo ou Ranked Flex');
                                                                                                                                                            }}
                                                                                                                                                            if (!playerRank9[0]) {
                                                                                                                                                                ActualGameLol.addFields(
                                                                                                                                                                    { name: `${currentGame['participants'][8]['summonerName']}`, value: `${playerChampNumber9['name']}`, inline: true },
                                                                                                                                                                    )
                                                                                                                                                        }
